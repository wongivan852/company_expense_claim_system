...
class ExpenseSystemCache:
    ...
    def get_user_permissions(cls, user_id):
        ...
        if permissions is None:
            try:
                ...
                permissions = {
                    'can_approve': user.has_perm('claims.can_approve_claims'),
                    'can_view_all': user.has_perm('claims.can_view_all_claims'),
    ...
    def get_active_currencies(cls):
        ...
        if currencies is None:
            try:
                from claims.models import Currency
                currencies = list(
    ...
    def get_exchange_rates(cls, date=None):
        ...
        if rates is None:
            try:
                from claims.models import Currency, ExchangeRate
                rates = {}
